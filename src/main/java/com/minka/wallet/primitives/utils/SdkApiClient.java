...
/***
 * Cliente para la integracion con el servicio WEB de TINAPI de ACH TIN
 */
public class SdkApiClient {

    private io.minka.api.handler.DefaultApi api;
    private CustomApiClient apiClient;
     ...
     *
     * @return un Keeper con la llave p̼blica, privada y el scheme (tipo de firma)
     */
    ...
    /**
     * Solicita una pareja de llave privada y p̼blica al Web service de TINAPI o
     * la genera localmente para el flag offline.
     * @deprecated Se recomienda usar el m̩todo getKeeperForOfflineSigning para generar las llaves localmente.
     * @return un objeto con las llaves (privada y p̼blica)
     */
    @Deprecated
