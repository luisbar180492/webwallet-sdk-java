...
//import com.minka.api.handler.StoreApi;
...
//        String sourceHandle = "$bankOfAmerica3";// + RandomStringUtils.random(3);
...
////        signerTemporalApi.getApiClient().setBasePath(CLOUD_URL);
...
////        CreateActionStoreRequest storeReq = new CreateActionStoreRequest();
////        storeReq.setAmount(amount);
////        storeReq.setSource(sourceHandle);
////        storeReq.setSymbol(sourceHandle);
////        storeReq.setTarget(targetHandle);
////        storeReq.setLabels(new HashMap<>());
////
////        System.out.println(storeReq);
////        storeApi.createActionStore(API_KEY, storeReq);
//
